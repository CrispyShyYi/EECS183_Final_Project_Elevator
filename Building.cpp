...
void Building::spawnPerson(Person newPerson){
    ...
    // newPerson.getCurrentFloor().addPerson(newPerson, req);
...
void Building::update(Move move){
    ...
    if (move.isPickupMove()) {
      // move.getTargetFloor().removePerson();
      // removePeople(, getNumPeopleToPickup)
...
int Building::tick(Move move) {
    ...
    // floors[elevators[move.getElevatorId()].getCurrentFloor()].tick(time)
